...
namespace Lukasz\Vehicle\Ui\Component\Listing\Column;
...
class VehicleAcions extends Column
{
/**
* Url path
*/
const URL_PATH_EDIT = 'lukasz_vehicles/vehicle/edit';
const URL_PATH_DELETE = 'lukasz_vehicles/vehicle/delete';
